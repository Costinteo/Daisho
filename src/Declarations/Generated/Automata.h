...
#define CTYPE_rules { CTYPE_rule_1, CTYPE_rule_2, CTYPE_rule_3, CTYPE_rule_4, CTYPE_rule_5 };
#define CTYPE_DFA { .rules = CTYPE_rules, .num_rules = ARR_SIZE(CTYPE_rules), .accepting_state = 6 };
...
#define BOOL_rules { BOOL_rule_1, BOOL_rule_2, BOOL_rule_3, BOOL_rule_4 };
#define BOOL_DFA { .rules = BOOL_rules, .num_rules = ARR_SIZE(BOOL_rules), .accepting_state = 5 };
...
#define CHAR_rules { CHAR_rule_1, CHAR_rule_2, CHAR_rule_3, CHAR_rule_4 };
#define CHAR_DFA { .rules = CHAR_rules, .num_rules = ARR_SIZE(CHAR_rules), .accepting_state = 5 };
...
#define UCHAR_rules { UCHAR_rule_1, UCHAR_rule_2, UCHAR_rule_3, UCHAR_rule_4, UCHAR_rule_5 };
#define UCHAR_DFA { .rules = UCHAR_rules, .num_rules = ARR_SIZE(UCHAR_rules), .accepting_state = 6 };
...
#define SHORT_rules { SHORT_rule_1, SHORT_rule_2, SHORT_rule_3, SHORT_rule_4, SHORT_rule_5 };
#define SHORT_DFA { .rules = SHORT_rules, .num_rules = ARR_SIZE(SHORT_rules), .accepting_state = 6 };
...
#define USHORT_rules { USHORT_rule_1, USHORT_rule_2, USHORT_rule_3, USHORT_rule_4, USHORT_rule_5, USHORT_rule_6 };
#define USHORT_DFA { .rules = USHORT_rules, .num_rules = ARR_SIZE(USHORT_rules), .accepting_state = 7 };
...
#define INT_rules { INT_rule_1, INT_rule_2, INT_rule_3 };
#define INT_DFA { .rules = INT_rules, .num_rules = ARR_SIZE(INT_rules), .accepting_state = 4 };
...
#define UINT_rules { UINT_rule_1, UINT_rule_2, UINT_rule_3, UINT_rule_4 };
#define UINT_DFA { .rules = UINT_rules, .num_rules = ARR_SIZE(UINT_rules), .accepting_state = 5 };
...
#define LONG_rules { LONG_rule_1, LONG_rule_2, LONG_rule_3, LONG_rule_4 };
#define LONG_DFA { .rules = LONG_rules, .num_rules = ARR_SIZE(LONG_rules), .accepting_state = 5 };
...
#define FLOAT_rules { FLOAT_rule_1, FLOAT_rule_2, FLOAT_rule_3, FLOAT_rule_4, FLOAT_rule_5 };
#define FLOAT_DFA { .rules = FLOAT_rules, .num_rules = ARR_SIZE(FLOAT_rules), .accepting_state = 6 };
...
#define DOUBLE_rules { DOUBLE_rule_1, DOUBLE_rule_2, DOUBLE_rule_3, DOUBLE_rule_4, DOUBLE_rule_5, DOUBLE_rule_6 };
#define DOUBLE_DFA { .rules = DOUBLE_rules, .num_rules = ARR_SIZE(DOUBLE_rules), .accepting_state = 7 };
...
#define VOID_rules { VOID_rule_1, VOID_rule_2, VOID_rule_3, VOID_rule_4 };
#define VOID_DFA { .rules = VOID_rules, .num_rules = ARR_SIZE(VOID_rules), .accepting_state = 5 };
...
#define IF_rules { IF_rule_1, IF_rule_2 };
#define IF_DFA { .rules = IF_rules, .num_rules = ARR_SIZE(IF_rules), .accepting_state = 3 };
...
#define ELSE_rules { ELSE_rule_1, ELSE_rule_2, ELSE_rule_3, ELSE_rule_4 };
#define ELSE_DFA { .rules = ELSE_rules, .num_rules = ARR_SIZE(ELSE_rules), .accepting_state = 5 };
...
#define FOR_rules { FOR_rule_1, FOR_rule_2, FOR_rule_3 };
#define FOR_DFA { .rules = FOR_rules, .num_rules = ARR_SIZE(FOR_rules), .accepting_state = 4 };
...
#define WHILE_rules { WHILE_rule_1, WHILE_rule_2, WHILE_rule_3, WHILE_rule_4, WHILE_rule_5 };
#define WHILE_DFA { .rules = WHILE_rules, .num_rules = ARR_SIZE(WHILE_rules), .accepting_state = 6 };
...
#define CONTINUE_rules { CONTINUE_rule_1, CONTINUE_rule_2, CONTINUE_rule_3, CONTINUE_rule_4, CONTINUE_rule_5, CONTINUE_rule_6, CONTINUE_rule_7, CONTINUE_rule_8 };
#define CONTINUE_DFA { .rules = CONTINUE_rules, .num_rules = ARR_SIZE(CONTINUE_rules), .accepting_state = 9 };
...
#define BREAK_rules { BREAK_rule_1, BREAK_rule_2, BREAK_rule_3, BREAK_rule_4, BREAK_rule_5 };
#define BREAK_DFA { .rules = BREAK_rules, .num_rules = ARR_SIZE(BREAK_rules), .accepting_state = 6 };
...
#define IN_rules { IN_rule_1, IN_rule_2 };
#define IN_DFA { .rules = IN_rules, .num_rules = ARR_SIZE(IN_rules), .accepting_state = 3 };
...
#define CLASS_rules { CLASS_rule_1, CLASS_rule_2, CLASS_rule_3, CLASS_rule_4, CLASS_rule_5 };
#define CLASS_DFA { .rules = CLASS_rules, .num_rules = ARR_SIZE(CLASS_rules), .accepting_state = 6 };
...
#define THIS_rules { THIS_rule_1, THIS_rule_2, THIS_rule_3, THIS_rule_4 };
#define THIS_DFA { .rules = THIS_rules, .num_rules = ARR_SIZE(THIS_rules), .accepting_state = 5 };
...
#define OPERATOR_rules { OPERATOR_rule_1, OPERATOR_rule_2, OPERATOR_rule_3, OPERATOR_rule_4, OPERATOR_rule_5, OPERATOR_rule_6, OPERATOR_rule_7, OPERATOR_rule_8 };
#define OPERATOR_DFA { .rules = OPERATOR_rules, .num_rules = ARR_SIZE(OPERATOR_rules), .accepting_state = 9 };
...
#define TRAIT_rules { TRAIT_rule_1, TRAIT_rule_2, TRAIT_rule_3, TRAIT_rule_4, TRAIT_rule_5 };
#define TRAIT_DFA { .rules = TRAIT_rules, .num_rules = ARR_SIZE(TRAIT_rules), .accepting_state = 6 };
...
#define IMPL_rules { IMPL_rule_1, IMPL_rule_2, IMPL_rule_3, IMPL_rule_4 };
#define IMPL_DFA { .rules = IMPL_rules, .num_rules = ARR_SIZE(IMPL_rules), .accepting_state = 5 };
...
#define ENUM_rules { ENUM_rule_1, ENUM_rule_2, ENUM_rule_3, ENUM_rule_4 };
#define ENUM_DFA { .rules = ENUM_rules, .num_rules = ARR_SIZE(ENUM_rules), .accepting_state = 5 };
...
#define PRIVATE_rules { PRIVATE_rule_1, PRIVATE_rule_2, PRIVATE_rule_3, PRIVATE_rule_4, PRIVATE_rule_5, PRIVATE_rule_6, PRIVATE_rule_7 };
#define PRIVATE_DFA { .rules = PRIVATE_rules, .num_rules = ARR_SIZE(PRIVATE_rules), .accepting_state = 8 };
...
#define PROTECTED_rules { PROTECTED_rule_1, PROTECTED_rule_2, PROTECTED_rule_3, PROTECTED_rule_4, PROTECTED_rule_5, PROTECTED_rule_6, PROTECTED_rule_7, PROTECTED_rule_8, PROTECTED_rule_9 };
#define PROTECTED_DFA { .rules = PROTECTED_rules, .num_rules = ARR_SIZE(PROTECTED_rules), .accepting_state = 10 };
...
#define PUBLIC_rules { PUBLIC_rule_1, PUBLIC_rule_2, PUBLIC_rule_3, PUBLIC_rule_4, PUBLIC_rule_5, PUBLIC_rule_6 };
#define PUBLIC_DFA { .rules = PUBLIC_rules, .num_rules = ARR_SIZE(PUBLIC_rules), .accepting_state = 7 };
...
#define INSTANCEOF_rules { INSTANCEOF_rule_1, INSTANCEOF_rule_2, INSTANCEOF_rule_3, INSTANCEOF_rule_4, INSTANCEOF_rule_5, INSTANCEOF_rule_6, INSTANCEOF_rule_7, INSTANCEOF_rule_8, INSTANCEOF_rule_9, INSTANCEOF_rule_10 };
#define INSTANCEOF_DFA { .rules = INSTANCEOF_rules, .num_rules = ARR_SIZE(INSTANCEOF_rules), .accepting_state = 11 };
...
#define SIZEOF_rules { SIZEOF_rule_1, SIZEOF_rule_2, SIZEOF_rule_3, SIZEOF_rule_4, SIZEOF_rule_5, SIZEOF_rule_6 };
#define SIZEOF_DFA { .rules = SIZEOF_rules, .num_rules = ARR_SIZE(SIZEOF_rules), .accepting_state = 7 };
...
#define ASSERT_rules { ASSERT_rule_1, ASSERT_rule_2, ASSERT_rule_3, ASSERT_rule_4, ASSERT_rule_5, ASSERT_rule_6 };
#define ASSERT_DFA { .rules = ASSERT_rules, .num_rules = ARR_SIZE(ASSERT_rules), .accepting_state = 7 };
...
#define TRUE_rules { TRUE_rule_1, TRUE_rule_2, TRUE_rule_3, TRUE_rule_4 };
#define TRUE_DFA { .rules = TRUE_rules, .num_rules = ARR_SIZE(TRUE_rules), .accepting_state = 5 };
...
#define FALSE_rules { FALSE_rule_1, FALSE_rule_2, FALSE_rule_3, FALSE_rule_4, FALSE_rule_5 };
#define FALSE_DFA { .rules = FALSE_rules, .num_rules = ARR_SIZE(FALSE_rules), .accepting_state = 6 };

#define LPAREN_rule_1 { .start_range = '(', .end_range = '(', .start_state = 1, .end_state = 2 };
#define LPAREN_rules { LPAREN_rule_1 };
#define LPAREN_DFA { .rules = LPAREN_rules, .num_rules = ARR_SIZE(LPAREN_rules), .accepting_state = 2 };

#define RPAREN_rule_1 { .start_range = ')', .end_range = ')', .start_state = 1, .end_state = 2 };
#define RPAREN_rules { RPAREN_rule_1 };
#define RPAREN_DFA { .rules = RPAREN_rules, .num_rules = ARR_SIZE(RPAREN_rules), .accepting_state = 2 };

#define LBRACE_rule_1 { .start_range = '{', .end_range = '{', .start_state = 1, .end_state = 2 };
#define LBRACE_rules { LBRACE_rule_1 };
#define LBRACE_DFA { .rules = LBRACE_rules, .num_rules = ARR_SIZE(LBRACE_rules), .accepting_state = 2 };

#define RBRACE_rule_1 { .start_range = '}', .end_range = '}', .start_state = 1, .end_state = 2 };
#define RBRACE_rules { RBRACE_rule_1 };
#define RBRACE_DFA { .rules = RBRACE_rules, .num_rules = ARR_SIZE(RBRACE_rules), .accepting_state = 2 };

#define LBRACK_rule_1 { .start_range = '[', .end_range = '[', .start_state = 1, .end_state = 2 };
#define LBRACK_rules { LBRACK_rule_1 };
#define LBRACK_DFA { .rules = LBRACK_rules, .num_rules = ARR_SIZE(LBRACK_rules), .accepting_state = 2 };

#define RBRACK_rule_1 { .start_range = ']', .end_range = ']', .start_state = 1, .end_state = 2 };
#define RBRACK_rules { RBRACK_rule_1 };
#define RBRACK_DFA { .rules = RBRACK_rules, .num_rules = ARR_SIZE(RBRACK_rules), .accepting_state = 2 };

#define LARROW_rule_1 { .start_range = '<', .end_range = '<', .start_state = 1, .end_state = 2 };
#define LARROW_rules { LARROW_rule_1 };
#define LARROW_DFA { .rules = LARROW_rules, .num_rules = ARR_SIZE(LARROW_rules), .accepting_state = 2 };

#define RARROW_rule_1 { .start_range = '>', .end_range = '>', .start_state = 1, .end_state = 2 };
#define RARROW_rules { RARROW_rule_1 };
#define RARROW_DFA { .rules = RARROW_rules, .num_rules = ARR_SIZE(RARROW_rules), .accepting_state = 2 };

#define SEMI_rule_1 { .start_range = ';', .end_range = ';', .start_state = 1, .end_state = 2 };
#define SEMI_rules { SEMI_rule_1 };
#define SEMI_DFA { .rules = SEMI_rules, .num_rules = ARR_SIZE(SEMI_rules), .accepting_state = 2 };

#define COMMA_rule_1 { .start_range = ',', .end_range = ',', .start_state = 1, .end_state = 2 };
#define COMMA_rules { COMMA_rule_1 };
#define COMMA_DFA { .rules = COMMA_rules, .num_rules = ARR_SIZE(COMMA_rules), .accepting_state = 2 };

#define DOT_rule_1 { .start_range = '.', .end_range = '.', .start_state = 1, .end_state = 2 };
#define DOT_rules { DOT_rule_1 };
#define DOT_DFA { .rules = DOT_rules, .num_rules = ARR_SIZE(DOT_rules), .accepting_state = 2 };

#define STAR_rule_1 { .start_range = '*', .end_range = '*', .start_state = 1, .end_state = 2 };
#define STAR_rules { STAR_rule_1 };
#define STAR_DFA { .rules = STAR_rules, .num_rules = ARR_SIZE(STAR_rules), .accepting_state = 2 };

#define EQUALS_rule_1 { .start_range = '=', .end_range = '=', .start_state = 1, .end_state = 2 };
#define EQUALS_rules { EQUALS_rule_1 };
#define EQUALS_DFA { .rules = EQUALS_rules, .num_rules = ARR_SIZE(EQUALS_rules), .accepting_state = 2 };
...
#define LAMBDA_ARROW_rules { LAMBDA_ARROW_rule_1, LAMBDA_ARROW_rule_2 };
#define LAMBDA_ARROW_DFA { .rules = LAMBDA_ARROW_rules, .num_rules = ARR_SIZE(LAMBDA_ARROW_rules), .accepting_state = 3 };

#define BANG_rule_1 { .start_range = '!', .end_range = '!', .start_state = 1, .end_state = 2 };
#define BANG_rules { BANG_rule_1 };
#define BANG_DFA { .rules = BANG_rules, .num_rules = ARR_SIZE(BANG_rules), .accepting_state = 2 };

#define TILDE_rule_1 { .start_range = '~', .end_range = '~', .start_state = 1, .end_state = 2 };
#define TILDE_rules { TILDE_rule_1 };
#define TILDE_DFA { .rules = TILDE_rules, .num_rules = ARR_SIZE(TILDE_rules), .accepting_state = 2 };

#define QUESTION_rule_1 { .start_range = '?', .end_range = '?', .start_state = 1, .end_state = 2 };
#define QUESTION_rules { QUESTION_rule_1 };
#define QUESTION_DFA { .rules = QUESTION_rules, .num_rules = ARR_SIZE(QUESTION_rules), .accepting_state = 2 };

#define COLON_rule_1 { .start_range = ':', .end_range = ':', .start_state = 1, .end_state = 2 };
#define COLON_rules { COLON_rule_1 };
#define COLON_DFA { .rules = COLON_rules, .num_rules = ARR_SIZE(COLON_rules), .accepting_state = 2 };
...
#define EQUAL_rules { EQUAL_rule_1, EQUAL_rule_2 };
#define EQUAL_DFA { .rules = EQUAL_rules, .num_rules = ARR_SIZE(EQUAL_rules), .accepting_state = 3 };
...
#define LE_rules { LE_rule_1, LE_rule_2 };
#define LE_DFA { .rules = LE_rules, .num_rules = ARR_SIZE(LE_rules), .accepting_state = 3 };
...
#define GE_rules { GE_rule_1, GE_rule_2 };
#define GE_DFA { .rules = GE_rules, .num_rules = ARR_SIZE(GE_rules), .accepting_state = 3 };
...
#define NOTEQUAL_rules { NOTEQUAL_rule_1, NOTEQUAL_rule_2 };
#define NOTEQUAL_DFA { .rules = NOTEQUAL_rules, .num_rules = ARR_SIZE(NOTEQUAL_rules), .accepting_state = 3 };
...
#define AND_rules { AND_rule_1, AND_rule_2 };
#define AND_DFA { .rules = AND_rules, .num_rules = ARR_SIZE(AND_rules), .accepting_state = 3 };
...
#define OR_rules { OR_rule_1, OR_rule_2 };
#define OR_DFA { .rules = OR_rules, .num_rules = ARR_SIZE(OR_rules), .accepting_state = 3 };
...
#define INC_rules { INC_rule_1, INC_rule_2 };
#define INC_DFA { .rules = INC_rules, .num_rules = ARR_SIZE(INC_rules), .accepting_state = 3 };
...
#define DEC_rules { DEC_rule_1, DEC_rule_2 };
#define DEC_DFA { .rules = DEC_rules, .num_rules = ARR_SIZE(DEC_rules), .accepting_state = 3 };

#define ADD_rule_1 { .start_range = '+', .end_range = '+', .start_state = 1, .end_state = 2 };
#define ADD_rules { ADD_rule_1 };
#define ADD_DFA { .rules = ADD_rules, .num_rules = ARR_SIZE(ADD_rules), .accepting_state = 2 };

#define SUB_rule_1 { .start_range = '-', .end_range = '-', .start_state = 1, .end_state = 2 };
#define SUB_rules { SUB_rule_1 };
#define SUB_DFA { .rules = SUB_rules, .num_rules = ARR_SIZE(SUB_rules), .accepting_state = 2 };

#define DIV_rule_1 { .start_range = '/', .end_range = '/', .start_state = 1, .end_state = 2 };
#define DIV_rules { DIV_rule_1 };
#define DIV_DFA { .rules = DIV_rules, .num_rules = ARR_SIZE(DIV_rules), .accepting_state = 2 };

#define AMP_rule_1 { .start_range = '&', .end_range = '&', .start_state = 1, .end_state = 2 };
#define AMP_rules { AMP_rule_1 };
#define AMP_DFA { .rules = AMP_rules, .num_rules = ARR_SIZE(AMP_rules), .accepting_state = 2 };

#define BITOR_rule_1 { .start_range = '|', .end_range = '|', .start_state = 1, .end_state = 2 };
#define BITOR_rules { BITOR_rule_1 };
#define BITOR_DFA { .rules = BITOR_rules, .num_rules = ARR_SIZE(BITOR_rules), .accepting_state = 2 };

#define CARET_rule_1 { .start_range = '^', .end_range = '^', .start_state = 1, .end_state = 2 };
#define CARET_rules { CARET_rule_1 };
#define CARET_DFA { .rules = CARET_rules, .num_rules = ARR_SIZE(CARET_rules), .accepting_state = 2 };

#define MOD_rule_1 { .start_range = '%', .end_range = '%', .start_state = 1, .end_state = 2 };
#define MOD_rules { MOD_rule_1 };
#define MOD_DFA { .rules = MOD_rules, .num_rules = ARR_SIZE(MOD_rules), .accepting_state = 2 };
...
#define DEREF_ARROW_rules { DEREF_ARROW_rule_1, DEREF_ARROW_rule_2 };
#define DEREF_ARROW_DFA { .rules = DEREF_ARROW_rules, .num_rules = ARR_SIZE(DEREF_ARROW_rules), .accepting_state = 3 };
...
#define ADD_ASSIGN_rules { ADD_ASSIGN_rule_1, ADD_ASSIGN_rule_2 };
#define ADD_ASSIGN_DFA { .rules = ADD_ASSIGN_rules, .num_rules = ARR_SIZE(ADD_ASSIGN_rules), .accepting_state = 3 };
...
#define SUB_ASSIGN_rules { SUB_ASSIGN_rule_1, SUB_ASSIGN_rule_2 };
#define SUB_ASSIGN_DFA { .rules = SUB_ASSIGN_rules, .num_rules = ARR_SIZE(SUB_ASSIGN_rules), .accepting_state = 3 };
...
#define MUL_ASSIGN_rules { MUL_ASSIGN_rule_1, MUL_ASSIGN_rule_2 };
#define MUL_ASSIGN_DFA { .rules = MUL_ASSIGN_rules, .num_rules = ARR_SIZE(MUL_ASSIGN_rules), .accepting_state = 3 };
...
#define DIV_ASSIGN_rules { DIV_ASSIGN_rule_1, DIV_ASSIGN_rule_2 };
#define DIV_ASSIGN_DFA { .rules = DIV_ASSIGN_rules, .num_rules = ARR_SIZE(DIV_ASSIGN_rules), .accepting_state = 3 };
...
#define AND_ASSIGN_rules { AND_ASSIGN_rule_1, AND_ASSIGN_rule_2 };
#define AND_ASSIGN_DFA { .rules = AND_ASSIGN_rules, .num_rules = ARR_SIZE(AND_ASSIGN_rules), .accepting_state = 3 };
...
#define OR_ASSIGN_rules { OR_ASSIGN_rule_1, OR_ASSIGN_rule_2 };
#define OR_ASSIGN_DFA { .rules = OR_ASSIGN_rules, .num_rules = ARR_SIZE(OR_ASSIGN_rules), .accepting_state = 3 };
...
#define XOR_ASSIGN_rules { XOR_ASSIGN_rule_1, XOR_ASSIGN_rule_2 };
#define XOR_ASSIGN_DFA { .rules = XOR_ASSIGN_rules, .num_rules = ARR_SIZE(XOR_ASSIGN_rules), .accepting_state = 3 };
...
#define MOD_ASSIGN_rules { MOD_ASSIGN_rule_1, MOD_ASSIGN_rule_2 };
#define MOD_ASSIGN_DFA { .rules = MOD_ASSIGN_rules, .num_rules = ARR_SIZE(MOD_ASSIGN_rules), .accepting_state = 3 };
